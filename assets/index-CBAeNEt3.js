...
`,$=(e,t)=>{switch(e){case t.main:return()=>j();case t.login:return()=>D();case t.profile:return()=>N();default:return()=>R()}},M=e=>$(e,x),F=e=>$(e,w),P=(e,t)=>{const n=new i().get();return!n&&e===t.profile?t.login:n&&e===t.login?t.main:e},C=e=>P(e,w),Z=e=>P(e,x),r=b(),B=()=>typeof process<"u"&&!1,U=(e,t)=>{const n=t.includes("#")?t:`${r}${t}`;e?window.location.hash=t:history.pushState(null,null,n)},L=(e,t)=>{const n=e(t);return U(t.includes("#"),n),n},m=e=>{if(window.location.hash)return c(e);if(window.location.pathname.includes("/index.hash.html"))return c("#/");e=e??window.location.pathname,r&&e.startsWith(r)&&(e=e.replace(r,"")),(e===""||e===r)&&(e="/"),e.startsWith("/")||(e=`/${e}`);const t=L(C,e);g(F(t))},c=e=>{let t=e??window.location.hash;t.includes("#")||(t=`#${t}`),r&&t.includes(`#${r}/`)&&(t=t.replace(`#${r}`,"#"));const n=L(Z,t);if(!window.location.pathname.includes("/index.hash.html")&&!B()){const o=`${r}/index.hash.html${n}`;window.location.href=o;return}g(M(n))},h=e=>{new i().set({username:e.username,email:e.email??"",bio:e.bio??""})},W=(e,t)=>{new d().addPost({username:e,content:t,createdAt:new Date})},z=e=>{if(e.target.tagName==="A"){e.preventDefault(),e.target.id==="logout"&&new i().clear();const t=e.target.getAttribute("href");if(window.location.pathname.includes("/index.hash.html")){const n=t.startsWith("#")?t:`#${t}`;c(n)}else m(t)}},J=e=>{e.preventDefault();const t=e.target,n=new FormData(t),o=Object.fromEntries(n);if(t.id==="login-form"&&o.username&&(h(o),window.location.pathname.includes("/index.hash.html")?c("#/profile"):m("/profile")),t.id==="profile-form"&&(h(o),alert("프로필이 업데이트 되었습니다.")),t.id==="post-form"){const s=new i().get();s.username&&(W(s.username,o.content),window.location.pathname.includes("/index.hash.html")?c("#/"):m("/"))}},q=()=>{window.location.hash?c():m()},K=()=>{c()},V=()=>{m()},E={click:z,submit:J,DOMContentLoaded:q,hashchange:K,popstate:V},G=e=>{window.addEventListener(e,E[e])},Q=e=>{window.removeEventListener(e,E[e])},X=()=>{const e=["click","submit","DOMContentLoaded","popstate","hashchange"];return e.forEach(G),()=>{e.forEach(Q)}};X();
