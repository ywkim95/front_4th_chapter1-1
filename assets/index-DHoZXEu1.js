    ...
    `:s+=`<li><a id="login-link" href="${o}" class="text-gray-600">로그인</a></li>`,`<header class="bg-blue-600 text-white p-4 sticky top-0">
      ...
      <nav class="bg-white shadow-md p-2 sticky top-14">
        ...
        <p>&copy; 2024 항해플러스. All rights reserved.</p>
          ...
          </div>`},k=()=>`${new c().get().map(T).join("")}`,H=()=>`<input name="username" id="username" type="hidden" value="${new r().get().username}"/>`,I=()=>{var e;return`
    <form id="post-form">
...
`,$=(e,t)=>{switch(e){case t.main:return()=>j();case t.login:return()=>D();case t.profile:return()=>N();default:return()=>R()}},M=e=>$(e,v),F=e=>$(e,w),P=(e,t)=>{const n=new r().get();return!n&&e===t.profile?t.login:n&&e===t.login?t.main:e},C=e=>P(e,w),Z=e=>P(e,v),l=b(),B=(e,t)=>{const n=t.includes("#")?t:`${l}${t}`;e?window.location.hash=t:history.pushState(null,null,n)},L=(e,t)=>{const n=e(t);return B(t.includes("#"),n),n},u=e=>{if(window.location.hash)return m(e);if(window.location.pathname.includes("/index.hash.html"))return m("#/");e=e??window.location.pathname,l&&e.startsWith(l)&&(e=e.replace(l,"")),(e===""||e===l)&&(e="/"),e.startsWith("/")||(e=`/${e}`);const t=L(C,e);p(F(t))},m=e=>{let t=e??window.location.hash;t.includes("#")||(t=`#${t}`);const n=L(Z,t);if(!window.location.pathname.includes("/index.hash.html")){const o=`${l}/index.hash.html${n}`;window.location.href=o;return}p(M(n))},h=e=>{new r().set({username:e.username,email:e.email??"",bio:e.bio??""})},U=(e,t)=>{new c().addPost({username:e,content:t,createdAt:new Date})},z=e=>{e.target.tagName==="A"&&(e.preventDefault(),e.target.id==="logout"&&new r().clear(),u(e.target.getAttribute("href")))},J=e=>{e.preventDefault();const t=e.target,n=new FormData(t),o=Object.fromEntries(n);if(t.id==="login-form"&&o.username&&(h(o),u("/profile")),t.id==="profile-form"&&(h(o),alert("프로필이 업데이트 되었습니다.")),t.id==="post-form"){const s=new r().get();s.username&&(U(s.username,o.content),u("/"))}},W=()=>{window.location.hash?m():u()},q=()=>{m()},K=()=>{u()},A={click:z,submit:J,DOMContentLoaded:W,hashchange:q,popstate:K},V=e=>{window.addEventListener(e,A[e])},G=e=>{window.removeEventListener(e,A[e])},Q=()=>{const e=["click","submit","DOMContentLoaded","popstate","hashchange"];return e.forEach(V),()=>{e.forEach(G)}};Q();
